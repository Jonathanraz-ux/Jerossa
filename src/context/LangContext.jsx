...
const translations = {
  fr: {
    ...
    // Hero Section
    'hero.badge': 'La marketplace B2B entre Madagascar & Maurice',
    'hero.title.line1': 'Les richesses de Madagascar,',
    'hero.title.accent': 'les opportunités de Maurice.',
    'hero.desc': 'Découvrez des produits authentiques et collaborez avec des producteurs et fournisseurs vérifiés au cœur de l’Océan Indien.',
    'hero.cta.primary': 'Explorer les produits',
    'hero.cta.secondary': 'Trouver un fournisseur',
    'hero.trust.profiles': 'Profils vérifiés',
    'hero.trust.shipping': 'Échanges Madagascar ↔ Maurice',
    'hero.trust.security': 'Transactions sécurisées',
    'hero.trust.direct': 'Liaison directe producteurs',
    'hero.scroll': 'Découvrir',
    // Hero Cards
    'hero.card1.tag': 'LIVRAISON & EXPORT',
    'hero.card1.title': 'Madagascar ↔ Maurice',
    'hero.card1.desc': 'Une logistique pensée pour vos échanges régionaux.',
    'hero.card1.status': 'Liaison active',
    'hero.card1.meta': 'Fret maritime & aérien direct',
    'hero.card2.tag': 'TRAÇABILITÉ & ORIGINE',
    'hero.card2.title': 'Des informations fournisseur transparentes',
    'hero.card2.desc': 'Données documentées et contact direct auprès des producteurs.',
    'hero.card2.badge': '100% Documenté',
    'hero.card2.meta': 'Vanille, épices & matières d\'exception',
  },
  en: {
    ...
    'nav.messages': 'Messages',
    // Hero Section
    'hero.badge': 'The B2B marketplace connecting Madagascar & Mauritius',
    'hero.title.line1': 'The wealth of Madagascar,',
    'hero.title.accent': 'the opportunities of Mauritius.',
    'hero.desc': 'Discover authentic natural goods and partner with verified suppliers across the Indian Ocean.',
    'hero.cta.primary': 'Explore products',
    'hero.cta.secondary': 'Find a supplier',
    'hero.trust.profiles': 'Verified profiles',
    'hero.trust.shipping': 'Madagascar ↔ Mauritius trade',
    'hero.trust.security': 'Secure transactions',
    'hero.trust.direct': 'Direct grower network',
    'hero.scroll': 'Discover',
    // Hero Cards
    'hero.card1.tag': 'SHIPPING & EXPORT',
    'hero.card1.title': 'Madagascar ↔ Mauritius',
    'hero.card1.desc': 'Streamlined regional logistics tailored for your trade.',
    'hero.card1.status': 'Active route',
    'hero.card1.meta': 'Direct sea & air freight',
    'hero.card2.tag': 'TRACEABILITY & ORIGIN',
    'hero.card2.title': 'Transparent & verified supplier data',
    'hero.card2.desc': 'Documented origin and direct traceability from local producers.',
    'hero.card2.badge': '100% Documented',
    'hero.card2.meta': 'Vanilla, spices & exceptional raw goods',
  },
};
